...
def login_page():
    st.markdown("<h1 style='text-align: center; color: white; margin-top: 40px; '>Login Page</h1>", unsafe_allow_html=True)
    st.markdown("")
    st.markdown("")
    st.markdown("")
...
def orders_management_page():
    ...
    with st.sidebar:
        page=option_menu("Orders Management", ["Completed Orders", 'Cancelled Orders','Returned Orders','Shipping Problems'],icons=['check-circle', 'ban','arrow-left','exclamation-circle'], menu_icon="list", default_index=0)
    egypt_governorates = [
    ...
    if page == "Completed Orders":
        ...
        if selected== 'Add Order':
            ...
            if hoodies > 0:
                hoodie_details = st.text_input("Enter Hoodie Details")
