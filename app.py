...
def login_page():
    ...
    st.markdown("<h1 style='text-align: center; color: #FF4B4B; margin-top: 0px; '>User Login</h1>", unsafe_allow_html=True)
    st.markdown("")
    st.markdown("")
    st.markdown("")
...
def orders_management_page():
    ...
    if page=="Customers":
        ...
        st.markdown("<h1 style='text-align: center; color: #FF4B4B; margin-top: -60px; '>🚚Shipping Problems</h1>", unsafe_allow_html=True)
